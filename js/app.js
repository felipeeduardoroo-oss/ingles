// ============================================================
// 1. DADOS: 1000 palavras + 50 frases contextuais (Cloze)
// ============================================================
...
// ===== BANCO DE FRASES CONTEXTUAIS (CLOZE) =====
const CLOZE_SENTENCES = [
    { en: "I _______ to the store yesterday.", answer: "went" },
    { en: "She _______ a new car last week.", answer: "bought" },
    { en: "They _______ playing soccer when it started to rain.", answer: "were" },
    { en: "He has _______ to London three times.", answer: "been" },
    { en: "We _______ dinner when the phone rang.", answer: "were having" },
    { en: "I _______ you tomorrow.", answer: "will call" },
    { en: "She _______ very happy with her test results.", answer: "was" },
    { en: "They _______ to the beach every summer.", answer: "go" },
    { en: "He _______ his keys at home.", answer: "left" },
    { en: "We _______ the movie already.", answer: "have seen" },
    { en: "I _______ a lot of books this year.", answer: "have read" },
    { en: "She _______ singing when she was young.", answer: "started" },
    { en: "They _______ to travel next month.", answer: "plan" },
    { en: "He _______ his homework before dinner.", answer: "finished" },
    { en: "We _______ at the hotel for two weeks.", answer: "stayed" },
    { en: "I _______ my phone yesterday.", answer: "lost" },
    { en: "She _______ a glass of water every morning.", answer: "drinks" },
    { en: "They _______ to the party last night.", answer: "went" },
    { en: "He _______ his car to work every day.", answer: "drives" },
    { en: "We _______ a great time at the beach.", answer: "had" },
    { en: "I _______ to music while I study.", answer: "listen" },
    { en: "She _______ her hair yesterday.", answer: "cut" },
    { en: "They _______ a new house next year.", answer: "will buy" },
    { en: "He _______ for the bus for 20 minutes.", answer: "has been waiting" },
    { en: "We _______ English for three years.", answer: "have studied" },
    { en: "I _______ to call you, but I forgot.", answer: "was going" },
    { en: "She _______ to the gym every Monday.", answer: "goes" },
    { en: "They _______ their friends last weekend.", answer: "visited" },
    { en: "He _______ a letter to his grandmother.", answer: "wrote" },
    { en: "We _______ the game if we practice more.", answer: "will win" },
    { en: "I _______ that movie before.", answer: "have seen" },
    { en: "She _______ her room every Saturday.", answer: "cleans" },
    { en: "They _______ a delicious dinner last night.", answer: "cooked" },
    { en: "He _______ to become a doctor.", answer: "wants" },
    { en: "We _______ to the mountains for vacation.", answer: "will go" },
    { en: "I _______ you were coming!", answer: "didn't know" },
    { en: "She _______ a lot of photos on her trip.", answer: "took" },
    { en: "They _______ a dog and a cat.", answer: "have" },
    { en: "He _______ his job last month.", answer: "quit" },
    { en: "We _______ a beautiful sunset yesterday.", answer: "saw" },
    { en: "I _______ to start a new hobby.", answer: "want" },
    { en: "She _______ to bed early every night.", answer: "goes" },
    { en: "They _______ a meeting right now.", answer: "are having" },
    { en: "He _______ his grandmother every Sunday.", answer: "calls" },
    { en: "We _______ our homework already.", answer: "have finished" },
    { en: "I _______ a new job next week.", answer: "will start" },
    { en: "She _______ the piano very well.", answer: "plays" },
    { en: "They _______ to the cinema yesterday.", answer: "went" },
    { en: "He _______ his car last week.", answer: "sold" },
    { en: "We _______ a great time at the party.", answer: "had" }
];
...
function selectCardsForSession(state) {
    ...
    if (currentContent === 'vocabulary') {
        ...
        const clozePart = buildSelection(clozePriority, clozeNew, clozeStable, clozeSlots);
        selected = [...vocabPart, ...clozePart];
        shuffle(selected);
    }
    return selected;
}
